"""
Django settings for djangoepgp project.
...
SECRET_KEY = 'django-insecure-8#tw65cp6n$v3ry#zbt(0uncsaw*l0@idtt#$@)!io83ua&n0@'
...
WSGI_APPLICATION = 'djangoepgp.wsgi.application'
